...
var httpClient = _interopDefault(require('@actions/http-client'));
var core$1 = _interopDefault(require('@octokit/core'));
var pluginRestEndpointMethods = _interopDefault(require('@octokit/plugin-rest-endpoint-methods'));
var pluginPaginateRest = _interopDefault(require('@octokit/plugin-paginate-rest'));
...
exports.GitHub = core$1.Octokit.plugin(pluginRestEndpointMethods.restEndpointMethods, pluginPaginateRest.paginateRest).defaults(defaults);
/**
...
${summary}
  `;
  await fs$1.writeFile(newChangesetPath, prettier.format(changesetContents, _objectSpread({}, prettierConfig, {
    parser: "markdown"
  })));
  return changesetID;
}
